        ...
        <div class="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
            ...
            <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <div class="hero-text col-span-6">
                    <h1 class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight">Encuentra a tu mejor amigo</h1>
                    <hr class=" w-12 h-1 bg-orange-500 rounded-full mt-8">
                    <p class="text-gray-800 text-base leading-relaxed mt-8 font-semibold">Sabemos que la mejor compañia es la de un peludo. Encuentra tu amigo ya!</p>
                    <div class="get-app flex space-x-5 mt-10 justify-center md:justify-start">
                        ...
                        <button class="google bg-white shadow-md px-3 py-2 rounded-lg flex items-center space-x-4">
                            ...
                            <div class="text">
                                <p class="text-xs text-gray-600" style="font-size: 0.5rem;">Descarga la app</p>
...
<div class="py-12 bg-gray-800">
    <h2 class="text-5xl  text-center bold text-white">Nuestros Aliados</h2>
</div>

    <div class="py-16">
        <div class="container m-auto px-6 mt-10">

         <div class="lg:flex justify-between items-center">

              <div class="lg:w-5/12 ">
                <img data-aos="fade-right" src=" https://images.unsplash.com/photo-1548199973-03cce0bbc87b?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80"
                style="transform: scale(1) perspective(1040px) rotateY(25deg) rotateX(0deg) rotate(0deg);" alt="" class="rounded">
              </div>

             <div class="lg:w-6/12 lg:p-0 p-7">
                <h1 data-aos="zoom-out-up" class="text-4xl font-bold leading-tight mb-5 capitalize">  Professional Tailwind theme designed for developers. </h1>
      ...
      <div class="bg-gray-50">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                <!-- <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_BH0EFH.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player> -->
